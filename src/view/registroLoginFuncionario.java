 ...
 * @author 182110041
 */
public class registroLoginFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form alunoMatricula
     */
    public registroLoginFuncionario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registroLoginFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registroLoginFuncionario().setVisible(true);
            }
        });
    }
